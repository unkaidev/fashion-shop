...
namespace CustomizedScssPhp\ScssPhp\SourceMap;
...
class SourceMapGenerator
{
     ...
     *
     * @var \CustomizedScssPhp\ScssPhp\SourceMap\Base64VLQ
     */
    protected $encoder;
     ...
     * @return string|null
     *
     * @throws \CustomizedScssPhp\ScssPhp\Exception\CompilerException If the file could not be saved
     * @deprecated
     */
