...
namespace CustomizedScssPhp\ScssPhp;

use CustomizedScssPhp\ScssPhp\Base\Range;
use CustomizedScssPhp\ScssPhp\Block\AtRootBlock;
use CustomizedScssPhp\ScssPhp\Block\CallableBlock;
use CustomizedScssPhp\ScssPhp\Block\DirectiveBlock;
use CustomizedScssPhp\ScssPhp\Block\EachBlock;
use CustomizedScssPhp\ScssPhp\Block\ElseBlock;
use CustomizedScssPhp\ScssPhp\Block\ElseifBlock;
use CustomizedScssPhp\ScssPhp\Block\ForBlock;
use CustomizedScssPhp\ScssPhp\Block\IfBlock;
use CustomizedScssPhp\ScssPhp\Block\MediaBlock;
use CustomizedScssPhp\ScssPhp\Block\NestedPropertyBlock;
use CustomizedScssPhp\ScssPhp\Block\WhileBlock;
use CustomizedScssPhp\ScssPhp\Compiler\CachedResult;
use CustomizedScssPhp\ScssPhp\Compiler\Environment;
use CustomizedScssPhp\ScssPhp\Exception\CompilerException;
use CustomizedScssPhp\ScssPhp\Exception\ParserException;
use CustomizedScssPhp\ScssPhp\Exception\SassException;
use CustomizedScssPhp\ScssPhp\Exception\SassScriptException;
use CustomizedScssPhp\ScssPhp\Formatter\Compressed;
use CustomizedScssPhp\ScssPhp\Formatter\Expanded;
use CustomizedScssPhp\ScssPhp\Formatter\OutputBlock;
use CustomizedScssPhp\ScssPhp\Logger\LoggerInterface;
use CustomizedScssPhp\ScssPhp\Logger\StreamLogger;
use CustomizedScssPhp\ScssPhp\Node\Number;
use CustomizedScssPhp\ScssPhp\SourceMap\SourceMapGenerator;
use CustomizedScssPhp\ScssPhp\Util\Path;
...
class Compiler
{
    ...
    /**
     * @var \CustomizedScssPhp\ScssPhp\Compiler\Environment
     */
    protected $env;
    /**
     * @var OutputBlock|null
     ...
     * @param string|null $path
     *
     * @return \CustomizedScssPhp\ScssPhp\Parser
     */
     ...
     *
     * @return \CustomizedScssPhp\ScssPhp\Formatter\OutputBlock
     */
     ...
     * Compile root
     *
     * @param \CustomizedScssPhp\ScssPhp\Block $rootBlock
     *
     * @return void
     */
     ...
     * Flatten selectors
     *
     * @param \CustomizedScssPhp\ScssPhp\Formatter\OutputBlock $block
     ...
     * Compile media
     *
     * @param \CustomizedScssPhp\ScssPhp\Block $media
     *
     * @return void
     */
     ...
     * Media parent
     *
     * @param \CustomizedScssPhp\ScssPhp\Formatter\OutputBlock $scope
     *
     * @return \CustomizedScssPhp\ScssPhp\Formatter\OutputBlock
     */
     ...
     * @param \CustomizedScssPhp\ScssPhp\Formatter\OutputBlock $out
     *
     * @return void
     */
     ...
     * Compile at-root
     *
     * @param \CustomizedScssPhp\ScssPhp\Block $block
     *
     * @return void
     */
     ...
     *
     * @param \CustomizedScssPhp\ScssPhp\Formatter\OutputBlock $scope
     * @param \CustomizedScssPhp\ScssPhp\Formatter\OutputBlock $previousScope
     *
     * @return OutputBlock
     */
     ...
     * Filter WITH rules
     *
     * @param \CustomizedScssPhp\ScssPhp\Block|\CustomizedScssPhp\ScssPhp\Formatter\OutputBlock $block
     * @param array                                                         $with
     * @param array                                                         $without
     *
     * @return bool
     ...
     * @param array[]                                $stms
     * @param \CustomizedScssPhp\ScssPhp\Formatter\OutputBlock $out
     * @param \CustomizedScssPhp\ScssPhp\Block                 $selfParent
     * @param string                                 $traceName
     *
     * @return void
     *
...
EOL;
     ...
     *
     * @param \CustomizedScssPhp\ScssPhp\Compiler\Environment $env
     * @param \CustomizedScssPhp\ScssPhp\Block                $selfParent
     *
     * @return array
     */
     ...
     * @param \CustomizedScssPhp\ScssPhp\Block $block
     *
     * @return \CustomizedScssPhp\ScssPhp\Compiler\Environment
     */
    ...
    public function addVariables(array $variables)
    {
        ...
        if ($triggerWarning) {
            @trigger_error('Passing raw values to as custom variables to the Compiler is deprecated. Use "\CustomizedScssPhp\ScssPhp\ValueConverter::parseValue" or "\CustomizedScssPhp\ScssPhp\ValueConverter::fromPhp" to convert them instead.', E_USER_DEPRECATED);
        }
    }
     ...
     *
     * @return \CustomizedScssPhp\ScssPhp\Compiler
     *
     ...
     * @return never
     *
     * @throws \CustomizedScssPhp\ScssPhp\Exception\CompilerException
     *
