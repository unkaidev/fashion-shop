...
namespace CustomizedScssPhp\ScssPhp\Node;

use CustomizedScssPhp\ScssPhp\Base\Range;
use CustomizedScssPhp\ScssPhp\Compiler;
use CustomizedScssPhp\ScssPhp\Exception\RangeException;
use CustomizedScssPhp\ScssPhp\Exception\SassScriptException;
use CustomizedScssPhp\ScssPhp\Node;
use CustomizedScssPhp\ScssPhp\Type;
use CustomizedScssPhp\ScssPhp\Util;
...
class Number extends Node implements \ArrayAccess
{
     ...
     * Output number
     *
     * @param \CustomizedScssPhp\ScssPhp\Compiler $compiler
     *
     * @return string
     */
